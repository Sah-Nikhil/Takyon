...
describe("reduce", () => {
  it("v0.9 appends deltas rather than replacing the answer", () => {
  ...
  it("v0.9 keeps the session when done does not repeat it", () => {
  ...
  it("v0.9 prefers the session done carries when it has one", () => {
  ...
  // what went wrong.
  it("v0.9 keeps a partial answer when the turn fails", () => {
